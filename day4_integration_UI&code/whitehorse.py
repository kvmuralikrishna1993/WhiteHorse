...
head = tk.Label(headframe, text="WHITE'HOR$E",fg = "black") #box2
...
path_label.config(width = 50,bd =5,font=('Courier', 20))
path_label.grid(row=0, column=1)

#Label for password entry
passwrd_label = tk.Entry(topframe)
passwrd_label.config(width = 50,bd =5,show ="*",font=('Courier', 20))
